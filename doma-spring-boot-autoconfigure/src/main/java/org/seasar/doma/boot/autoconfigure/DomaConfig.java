...
public class DomaConfig implements Config {
    ...
    /**
     * Hint to the number of rows that should be fetched. Ignored unless this value is greater than 0.
     */
    private int fetchSize = 0;
    /**
     * Number of seconds the driver will wait for a <code>Statement</code> object to execute. Ignored unless this value is greater than 0.
     */
    private int queryTimeout = 0;
    /**
     * Size in executing <code>PreparedStatement#addBatch()</code>. Regarded as 1 unless this value is greater than 1.
     */
