...
public class DomaApplicationListenerTest {
    ...
    public static class ConstructorTest {
        ...
        public void entityOnly() throws Exception {
            String beanName = "";
            Method method = EntityOnly.class.getDeclaredMethod("handle", TestEntity1.class);
        ...
        public void entityWithContext() throws Exception {
            String beanName = "";
            Method method = EntityWithContext.class.getDeclaredMethod("handle", TestEntity1.class,
        ...
        public void multiAnnotations() throws Exception {
            String beanName = "";
            Method method = MultiAnnotations.class.getDeclaredMethod("handle", TestEntity1.class);
            BeanFactory beanFactory = mock(BeanFactory.class);
            new DomaApplicationListener(beanName, method, beanFactory);
        }
        ...
        public void notEntity() throws Exception {
            ...
            String beanName = "";
            Method method = NotEntity.class.getDeclaredMethod("handle", TestEntity3.class);
            BeanFactory beanFactory = mock(BeanFactory.class);
            new DomaApplicationListener(beanName, method, beanFactory);
        }
        ...
        public void invalidContextClass() throws Exception {
            ee.expect(IllegalArgumentException.class);
            String beanName = "";
            Method method = InvalidContextClass.class.getDeclaredMethod("handle", TestEntity1.class,
        ...
        public void tooManyArgs() throws Exception {
            ee.expect(IllegalArgumentException.class);
            String beanName = "";
            Method method = TooManyArgs.class.getDeclaredMethod("handle", TestEntity1.class,
                    PreInsertContext.class, Object.class);
            BeanFactory beanFactory = mock(BeanFactory.class);
            new DomaApplicationListener(beanName, method, beanFactory);
        }
    ...
    public static class OnApplicationEventTest {
        ...
        public void handleEvent() throws Exception {
            ...
            DomaApplicationListener listener = new DomaApplicationListener(
                    "entityOnlyHandler",
                    EntityOnlyHandler.class.getDeclaredMethod("handle", TestEntity1.class),
                    context);
        ...
        public void handleEventWithContext() throws Exception {
            ...
            DomaApplicationListener listener = new DomaApplicationListener(
                    "withContextHandler",
                    WithContextHandler.class.getDeclaredMethod("handle", TestEntity1.class,
                            PreInsertContext.class),
                    context);
        ...
        static class PassthroughEventListenerFactory implements EventListenerFactory, Ordered {
